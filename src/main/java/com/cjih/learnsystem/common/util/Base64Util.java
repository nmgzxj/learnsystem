...
public class Base64Util {  
  ...
  public static void main(String args[]) {
	  String str="[2018-05-31 18:46:54] 1 --- X3_CHECKSTATE_ACK --- 9\n" + 
	  		"LIC标识:1\n" + 
	  		"INE标识:1\n" + 
	  		"ASN.1码流:\n" + 
	  		"30 0d 80 01 02 a1 08 a0 06 80 01 31 81 01 31 ";
	  String encodeStr = Base64Util.encode(str,"UTF-8");
		  System.out.println(encodeStr);
		  System.out.println(Base64Util.encode(encodeStr,"UTF-8"));
		  System.out.println(Base64Util.decode(encodeStr,"UTF-8"));
		  System.out.println(Base64Util.decode(Base64Util.decode(encodeStr,"UTF-8"),"UTF-8"));
	  }
